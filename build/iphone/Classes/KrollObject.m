...
//@interface WhacktaniumObject : NSObject
//@end

@interface WhacktaniumObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WhacktaniumObject class]])
		{
			for (NSString *key in [[(WhacktaniumObject*)o modules] allKeys])
			{
