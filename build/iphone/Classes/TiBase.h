...
// in simulator we redefine to format for Whacktanium Developer console
...
{\
	NSString * exceptionName = [@"org.whacktanium." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.whacktanium";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIWhacktaniumNativeItemNone = -1, 
	UIWhacktaniumNativeItemSpinner = -2,
	UIWhacktaniumNativeItemProgressBar = -3,
	
	UIWhacktaniumNativeItemSlider = -4,
	UIWhacktaniumNativeItemSwitch = -5,
	UIWhacktaniumNativeItemMultiButton = -6,
	UIWhacktaniumNativeItemSegmented = -7,
	
	UIWhacktaniumNativeItemTextView = -8,
	UIWhacktaniumNativeItemTextField = -9,
	UIWhacktaniumNativeItemSearchBar = -10,
	
	UIWhacktaniumNativeItemPicker = -11,
	UIWhacktaniumNativeItemDatePicker = -12,
	
	UIWhacktaniumNativeItemInfoLight = -13,
	UIWhacktaniumNativeItemInfoDark = -14,
	
	UIWhacktaniumNativeItemDisclosure = -15,
	
	UIWhacktaniumNativeItemContactAdd = -16
};
